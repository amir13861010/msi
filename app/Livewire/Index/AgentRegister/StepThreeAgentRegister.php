...
class StepThreeAgentRegister extends Component
{
    ...
    {
        $this->dispatch("variableSentThree",$value);
    }
    public function render()
    {
        return view('livewire.index.agent-register.step-three-agent-register');
    }
}
