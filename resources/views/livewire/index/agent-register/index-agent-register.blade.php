            ...
            <div id="wizard_container">
                ...
                <form id="wrapped">
                    ...
                    <div id="middle-wizard">
                        <div class="step" >
                            <livewire:index.agent-register.step-one-agent-register/>


                        </div>
                        <!-- /Step -->
                        <div class="step">
                            <livewire:index.agent-register.step-two-agent-register/>

                        </div>
                        <div class="step">
                            <livewire:index.agent-register.step-three-agent-register/>
                        </div>
                        <div class="step">
                            <livewire:index.agent-register.step-four-agent-register/>
                        </div>
